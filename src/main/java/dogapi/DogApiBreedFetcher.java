    ...
    public List<String> getSubBreeds(String breed) throws BreedFetcher.BreedNotFoundException {
        ...
        try (Response response = client.newCall(request).execute()) {
            if (response.body() == null) {
                throw new BreedFetcher.BreedNotFoundException("Empty response from dog.ceo API");
            }
            ...
            throw new BreedFetcher.BreedNotFoundException("Failed to fetch sub-breeds: " + e.getMessage());
        }
    }
}